...
export const createPolicySchema = z.object({
    body: z.object({
        ...
        vehicleClass: z.enum(['TW', 'PCV', 'PVT', 'GCV', 'Misc_D', 'CPM', 'Fire', 'Public_Liability', 'SAOD_TW', 'SAOD_PVT', 'BUNDLED_POLICY_TW', 'BUNDLED_POLICY_PVT', 'CPA', 'Home_Insurance', 'RAK_Policy', 'Others']).optional(),
