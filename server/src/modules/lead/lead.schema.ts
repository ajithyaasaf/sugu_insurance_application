...
export const createLeadSchema = z.object({
    body: z.object({
        ...
        productName: z.string().optional().or(z.literal('')).nullable(),
...
export const convertLeadSchema = z.object({
    ...
    body: z.object({
        ...
        registrationDate: z.string().optional().nullable(),
        vehicleClass: z.enum(['TW', 'PCV', 'PVT', 'GCV', 'Misc_D', 'CPM', 'Fire', 'Public_Liability', 'SAOD_TW', 'SAOD_PVT', 'BUNDLED_POLICY_TW', 'BUNDLED_POLICY_PVT', 'CPA', 'Home_Insurance', 'RAK_Policy', 'Others']).optional().nullable(),
